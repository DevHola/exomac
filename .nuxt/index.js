...
import nuxt_plugin_plugin_bed7e114 from 'nuxt_plugin_plugin_bed7e114' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_6e39b9c8 from 'nuxt_plugin_bootstrapvue_6e39b9c8' // Source: .\\bootstrap-vue.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Cocre-a Consultings","titleTemplate":"%s ||","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_bed7e114 === 'function') {
    await nuxt_plugin_plugin_bed7e114(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_6e39b9c8 === 'function') {
    await nuxt_plugin_bootstrapvue_6e39b9c8(app.context, inject)
  }

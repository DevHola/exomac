<template>
    <div class="p-1" style="padding-top:10px;">
        <div class="container">
           <div class="container pl-5">
               <h1 class="text-left mt-5">Cocre-a Consults</h1>
               <p class="text-left">We are a global strategic Human Capital solutions provider with a team of seasoned individuals with a wide range of backgrounds and industry expertise who work across boards to tackle various HR difficulties. We construct methods that assist organizations in achieving their goals, making a profit, and reducing costs by attracting and developing the right talent, as well as creating an ideal organization that fosters productivity and innovation and collaboration.
<b>Cocre-a bridges the gap of need for employers and jobseekers</b>. </p>
           </div>
           <br>
           <section class="py-5 ">
                <div class="container px-5">
                    <div class="row gx-5 align-items-center">
                        <div class="col-lg-6 order-first order-lg-last"><h2 class="fw-bolder">Our Vision</h2>
                            <p class="lead fw-normal text-muted mb-0">Becoming the leading Human Capital and Resources Managers in Africa..</p></div>
                        <div class="col-lg-6">

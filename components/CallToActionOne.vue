<template>
    <div class="section-padding-t90-b100">
        <div class="container shape-animate">
            <!-- Section Title Start -->
            <SectionTitle title="We are a global strategic Human Capital solutions provider" sub-title="A Team of seasoned professionals from diverse backgrounds and industry experience to resolve various HR issues ." add-class-name="mb-30" />
            <!-- Section Title End -->
